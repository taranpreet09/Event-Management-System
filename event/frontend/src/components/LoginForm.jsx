  ...
  return (
    <div>
      {step === 'ENTER_EMAIL' ? (
        ...
        <div>
          {organisationName ? (
            <h2 className="text-2xl font-bold text-center mb-2">Welcome, {organisationName}</h2>
          ) : (
