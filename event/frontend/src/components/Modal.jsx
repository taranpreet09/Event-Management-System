...
const Modal = ({ children, onClose }) => {
  return (
    // Backdrop: Added transition and opacity classes
    <div 
      onClick={onClose}
    ...
    >
      {/* Modal Panel: Added transition for scale and opacity */}
      <div 
        ...
        style={{ transform: 'scale(1)', opacity: '1' }} // Final state for transition
      >
        {/* Close Button: Added hover effect */}
        <button 
          onClick={onClose}
